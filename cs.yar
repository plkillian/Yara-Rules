...
rule cobalt_strike_TSE588C_1
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <900KB and (pe.imphash()=="bb8169128c5096ea026d19888c139f1a" or 10 of them )
}
...
rule trickbot_kpsiwn
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <1000KB and (pe.imphash()=="a885f66621e03089e6c6a82d44a5ebe3" or 10 of them )
}



rule cobalt_strike_TSE28DF_1
{
	meta:
		vti_default_score = 3
		vti_documents_score = 3
	...
	condition:
		uint16(0)==0x5a4d and filesize <700KB and (pe.imphash()=="ab74ed3f154e02cfafb900acffdabf9e" or all of them )
}
...
rule bazar_M1E1626
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="578738b5c4621e1bf95fce0a570a7cfc" or 8 of them )
}
...
rule bazar_files_netscan
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="e9d20acdeaa8947f562cf14d3976522e" or 8 of them )
}
...
rule mimikatz_1014
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <3000KB and (pe.imphash()=="a0444dc502edb626311492eb9abac8ec" or 1 of ($x*))
}
...
rule masscan_1014
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <700KB and (pe.imphash()=="9b0b559e373d62a1c93e615f003f8af8" or 10 of them )
}
...
rule XMRig_CPU_mine_1014
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <19000KB and (pe.imphash()=="5c21c3e071f2116dcdb008ad5fc936d4" or 8 of them )
}
...
rule bazar_14wfa5dfs
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <3000KB and (pe.imphash()=="d8af53b239700b702d462c81a96d396c" and 8 of them )
}



rule cobalt_strike_tmp01925d3f_1
{
	meta:
		vti_default_score = 3
		vti_documents_score = 3
	...
	condition:
		uint16(0)==0x5a4d and filesize <1000KB and (pe.imphash()=="1b1b73382580c4be6fa24e8297e1849d" and (1 of ($x*) or 8 of them ))
}
...
rule advanced_ip_scanner
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <5000KB and (pe.imphash()=="a3bc8eb6ac4320e91b7faf1e81af2bbf" and 8 of them )
}
...
rule anchor_x64
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <1000KB and (pe.imphash()=="e2450fb3cc5b1b7305e3193fe03f3369" and (1 of ($x*) or 8 of them ))
}
...
rule anchorAsjuster_x64
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <700KB and (pe.imphash()=="9859b7a32d1227be2ca925c81ae9265e" and 8 of them )
}
...
rule icedid_032021_1
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <100KB and (pe.imphash()=="67a065c05a359d287f1fed9e91f823d5" and (pe.exports("PstmStr") and pe.exports("update")) or all of them )
}
...
rule icedid_032021_2
{
	...
	condition:
		uint16(0)==0x43da and filesize <1000KB and 8 of them
}
...
rule lazagne_ls_11462
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <23000KB and (pe.imphash()=="a62ff465f3ead2e578f02d3a2d749b7b" or 8 of them )
}
...
rule quantum_license
{
	...
	condition:
		uint16(0)==0x44f8 and filesize <1000KB and 8 of them
}
...
rule quantum_p227
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="c88d91896dd5b7d9cb3f912b90e9d0ed" or 8 of them )
}
...
rule Ulfefi32
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <100KB and (pe.imphash()=="81782d8702e074c0174968b51590bf48" and (pe.exports("FZKlWfNWN") and pe.exports("IMlNwug") and pe.exports("RPrWVBw") and pe.exports("kCXkdKtadW") and pe.exports("pLugSs") and pe.exports("pRNAU")) or 8 of them )
}
...
rule quantum_ttsel
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <200KB and (pe.imphash()=="68b5e41a24d5a26c1c2196733789c238" or 8 of them )
}
...
rule bumblebee_13842_StolenImages_Evidence_iso
{
	...
	condition:
		uint16(0)==0x0000 and filesize <13000KB and 1 of ($x*) and 4 of them
}
...
rule llJyMIOvft_14335
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <3000KB and (pe.imphash()=="066c972d2129d0e167d371a0abfcf03b" and (pe.exports("YAeJyEAYL7F4eDck6YUaf") and pe.exports("fmFkmnQYB5TC2Sq5NGFkK") and pe.exports("nrDjhnkd9nedaQwcCY")) or 12 of them )
}
...
rule case_18543_pimpliest_kufic_png
{
	...
	condition:
		uint16(0)==0x5089 and filesize <400KB and 8 of them
}
...
rule case_19438_files_MalFiles_NSM
{
	...
	condition:
		uint16(0)==0x3231 and filesize <1KB and 8 of them
}
...
rule case_19438_files_MalFiles_NSM_2
{
	...
	condition:
		uint16(0)==0x0a0d and filesize <20KB and 8 of them
}
...
rule nskbfltr
{
	...
	condition:
		uint16(0)==0x203b and filesize <1KB and all of them
}
...
rule case_19530_CS_beacon
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <800KB and (pe.imphash()=="49145e436aa571021bb1c7b727f8b049" or 8 of them )
}
...
rule sus_nsis_tampered_signature : TESTING SUSPICIOUS TA0005 T1027 T1027_005
{
	...
	condition:
		uint16(0)==0x5A4D and (3 of ($brand_*) or 2 of ($code_*)) and not 1 of ($signature_*)
}
...
rule click_php
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <1000KB and (pe.imphash()=="8948fb754b7c37bc4119606e044f204c" and pe.exports("StartW") or 10 of them )
}
...
rule sysrv013
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <10000KB and (pe.imphash()=="406f4cbdf82bde91761650ca44a3831a" or 8 of them )
}
...
rule icedid_rate_x32
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <700KB and (pe.imphash()=="15787e97e92f1f138de37f6f972eb43c" and (pe.exports("?jutre@@YAHXZ") and pe.exports("?klopW@@YAHXZ") and pe.exports("PluginInit") and pe.exports("update")) or 8 of them )
}
...
rule conti_cobaltstrike_192145
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="5cf3cdfe8585c01d2673249153057181" and pe.exports("StartW") or (1 of ($x*) or 4 of them ))
}
...
rule conti_cobaltstrike_icju1
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="a6d9b7f182ef1cfe180f692d89ecc759" or (1 of ($x*) or 4 of them ))
}
...
rule conti_cobaltstrike_192145_icju1_0_1
{
	meta:
		vti_default_score = 3
		vti_documents_score = 3
...
rule icedid_upefkuin4_3930
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <700KB and (pe.imphash()=="87bed5a7cba00c7e1f4015f1bdae2183" and (pe.exports("?keptyu@@YAHXZ") and pe.exports("?ortpw@@YAHXZ") and pe.exports("?sorty@@YAHXZ") and pe.exports("?sortyW@@YAHXZ") and pe.exports("PluginInit") and pe.exports("update")) or 8 of them )
}
...
rule icedid_license_3930
{
	...
	condition:
		uint16(0)==0x02ee and filesize <1000KB and 8 of them
}
...
rule sig_95_dll_cobalt_strike
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <100KB and (pe.imphash()=="67fdc237b514ec9fab9c4500917eb60f" and (pe.exports("AserSec") and pe.exports("TstSec")) or all of them )
}
...
rule case_4485_Muif
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <70KB and (pe.imphash()=="42205b145650671fa4469a6321ccf8bf" and pe.exports("StartW") or 8 of them )
}
...
rule textboxNameNamespace_2
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <500KB and (pe.imphash()=="4d46e641e0220fb18198a7e15fa6f49f" and (pe.exports("PluginInit") and pe.exports("alshaswlqmhptxpc") and pe.exports("amgqilvxdufvpdbwb") and pe.exports("atttyokowqnj") and pe.exports("atxvtwd") and pe.exports("ayawgsgkusfjmq")) or 8 of them )
}
...
rule case_4485_ekix4
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <11000KB and (pe.imphash()=="547a74a834f9965f00df1bd9ed30b8e5" or 8 of them )
}
...
rule sig_4641_fQumH
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <4000KB and (pe.imphash()=="67f1f64a3db0d22bf48121a6cea1da22" or 8 of them )
}
...
rule sig_4641_tdrE934
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="4f1ec786c25f2d49502ba19119ebfef6" or 8 of them )
}
...
rule sig_4641_netscan
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <6000KB and (pe.imphash()=="573e7039b3baff95751bded76795369e" and (pe.exports("__dbk_fcall_wrapper") and pe.exports("dbkFCallWrapperAddr")) or 8 of them )
}
...
rule sig_4641_tdr615
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <10000KB and (pe.imphash()=="555560b7871e0ba802f2f6fbf05d9bfa" or 8 of them )
}
...
rule CS_DLL_1
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <70KB and (pe.imphash()=="42205b145650671fa4469a6321ccf8bf") or ( all of them )
}
...
rule __case_5295_1407
{
	...
	condition:
		uint16(0)==0xa880 and filesize <2KB and all of them
}
...
rule cobalt_strike_exe21
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <800KB and (pe.imphash()=="17b461a082950fc6332228572138b80c" or 8 of them )
}
...
rule xinglocker_update64
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <500KB and (pe.imphash()=="309f189ae3d618bfd1e08a8538aea73a" and (pe.exports("MkozycymwrxdxsUdddknsoskqjj") and pe.exports("NnzvpyfnjzgjflhXgbihjsjauma") and pe.exports("StartW") and pe.exports("WldxpodTdikvburej") and pe.exports("WqtzhacNqtdeAkecz") and pe.exports("startW")) or 8 of them )
}
...
rule o4IRWsH4N1a3hjO9Sy2rPP02oyUddH7zA5xGih0ESmlhiiXD9kpWVCPfOwUnayZp_locker
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <600KB and (pe.imphash()=="50472e0ba953856d228c7483b149ea72" or all of them )
}
...
rule o4IRWsH4N1a3hjO9Sy2rPP02oyUddH7zA5xGih0ESmlhiiXD9kpWVCPfOwUnayZp_locker_x86
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <600KB and (pe.imphash()=="749dc5143e9fc01aa1d221fb9a48d5ea" or all of them )
}
...
rule o4IRWsH4N1a3hjO9Sy2rPP02oyUddH7zA5xGih0ESmlhiiXD9kpWVCPfOwUnayZp_locker_x64
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <600KB and (pe.imphash()=="137fa89046164fe07e0dd776ed7a0191" or all of them )
}
...
rule sig_6898_dcrypt
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <5000KB and (pe.imphash()=="48aa5c8931746a9655524f67b25a47ef" and all of them )
}
...
rule ocrafh_html_7685
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="fadf54554241c990b4607d042e11e465" and (pe.exports("Dropleave") and pe.exports("GlassExercise") and pe.exports("Mehope") and pe.exports("Top")) or 8 of them )
}
...
rule ljncxcwmsg_7685
{
	...
	condition:
		uint16(0)==0xa5a4 and filesize <2000KB and 8 of them
}
...
rule hyietnrfrx_7685
{
	...
	condition:
		uint16(0)==0x4eee and filesize <2000KB and 8 of them
}
...
rule zsokarzi_7685
{
	...
	condition:
		uint16(0)==0xc1d7 and filesize <2000KB and 8 of them
}
...
rule uvvfvnnswte
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="1a4ea0d6f08424c00bbeb4790cdf1ca7" and (pe.exports("GhlqallxvchxEpmvydvyzqt") and pe.exports("PyflzyhnwVkaNixwdqktzn")) or 8 of them )
}
...
rule SharedFiles
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="c270086ea8ef591ab09b6ccf85dc6072" and pe.exports("BasicScore") or 8 of them )
}
...
rule files_tmp
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <5000KB and (pe.imphash()=="59e16a2afa5b682bb9692bac873fa10c" and (pe.exports("EnterDll") and pe.exports("alpjxriee") and pe.exports("arcfqsbobtwbjrf") and pe.exports("asblsmvdudmlwht") and pe.exports("bgttsajxwgwrsai") and pe.exports("bosaplw")) or 8 of them )
}
...
rule Documents
{
	...
	condition:
		uint16(0)==0x004c and filesize <3KB and 1 of ($x*) and all of them
}
...
rule qbot_8734_payload_dll
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <2000KB and (pe.imphash()=="aa8a9db10fba890f8ef9edac427eab82" and pe.exports("CreatePaint") or 8 of them )
}
...
rule CS_default_exe_beacon_stager
{
	...
	condition:
		uint16(0)==0x5a4d and filesize <800KB and (pe.imphash()=="93f7b1a7b8b61bde6ac74d26f1f52e8d" and 3 of them ) or ( all of them )
}
...
rule conti_cobaltstrike_192145_icju1_0_2
{
	meta:
		vti_default_score = 3
		vti_documents_score = 3
...
rule cobalt_strike_tmp01925d3f_2
{
	meta:
		vti_default_score = 3
		vti_documents_score = 3
	...
	condition:
		uint16(0)==0x5a4d and filesize <1000KB and (pe.imphash()=="1b1b73382580c4be6fa24e8297e1849d" or (1 of ($x*) or 4 of them ))
}



rule cobalt_strike_TSE28DF_2
{
	meta:
		vti_default_score = 3
		vti_documents_score = 3
